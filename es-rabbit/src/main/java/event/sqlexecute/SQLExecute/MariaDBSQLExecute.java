package event.sqlexecute.SQLExecute;
...
public class MariaDBSQLExecute {
    ...
    public boolean initConnect() {
        ...
        try {
            ...
            String dbUser = props.get("MYSQL_DB_USR").toString();
            String dbPwd = props.get("MYSQL_DB_PWD").toString();
            Class.forName("org.mariadb.jdbc.Driver");
            String connectStr = "jdbc:mariadb://" + dbHost + ":" + dbPort + "/" + dbSchema;

            this.connection = DriverManager.getConnection(connectStr, dbUser, dbPwd);
